      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Items, Actions & Events', slug: 'core-concepts/items-actions-events', badge: { text: 'Sprint', variant: 'tip' } },
            { label: 'Glossary', slug: 'core-concepts/glossary' },
            {
              label: 'Architecture',
              items: [
                { label: 'High-Level Architecture', slug: 'core-concepts/architecture/high-level-architecture', badge: { text: 'Sprint', variant: 'tip' } },
                { label: 'Signals DPG', slug: 'core-concepts/architecture/signals-dpg', badge: { text: 'Sprint', variant: 'tip' } },
                { label: 'Signals Search', slug: 'core-concepts/architecture/signals-search', badge: { text: 'New', variant: 'tip' } },
                { label: 'Notification Service', slug: 'core-concepts/architecture/notification-service', badge: { text: 'New', variant: 'tip' } },
                { label: 'Aggregator DPG', slug: 'core-concepts/architecture/aggregator-dpg', badge: { text: 'Sprint', variant: 'tip' } },
                { label: 'Data Model', slug: 'core-concepts/architecture/data-model' },
                { label: 'Identity & Auth', slug: 'core-concepts/architecture/identity-and-auth', badge: { text: 'Sprint', variant: 'tip' } },
                { label: 'Infrastructure & Deployment', slug: 'core-concepts/architecture/infrastructure', badge: { text: 'Sprint', variant: 'tip' } },
              ],
            },
            {
              ...
              items: [
                ...
                { label: 'Tech Stack', slug: 'core-concepts/technical/tech-stack', badge: { text: 'Sprint', variant: 'tip' } },
              ],
            },
          ],
        },
        {
          ...
          items: [
            ...
            { label: 'Configuration', slug: 'guides/configuration', badge: { text: 'Sprint', variant: 'tip' } },
            { label: 'API Guide', slug: 'guides/api-reference' },
            { label: 'CI/CD & Build Pipeline', slug: 'guides/cicd-and-builds', badge: { text: 'Sprint', variant: 'tip' } },
            { label: 'Deployment', slug: 'guides/deployment', badge: { text: 'Sprint', variant: 'tip' } },
          ],
        },
        {
          label: 'API Reference',
