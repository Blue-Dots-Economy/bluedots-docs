      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Signals (Blue Dots)', slug: 'core-concepts/signals', badge: { text: 'UPD', variant: 'caution' } },
            { label: 'The Blue Dot Lifecycle', slug: 'core-concepts/blue-dot-lifecycle', badge: { text: 'NEW', variant: 'success' } },
            { label: 'Participant Profiles', slug: 'core-concepts/participant-profiles', badge: { text: 'NEW', variant: 'success' } },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Activating in a District', slug: 'guides/district-activation', badge: { text: 'UPD', variant: 'caution' } },
            ...
            { label: 'Customisation & Branding', slug: 'guides/customisation', badge: { text: 'NEW', variant: 'success' } },
            { label: 'AI Voice Agent Prompts', slug: 'guides/voice-ai-prompts', badge: { text: 'NEW', variant: 'success' } },
        ...
        },
        {
          ...
          items: [
            ...
            { label: "What We're Learning", slug: 'explore/learnings', badge: { text: 'NEW', variant: 'success' } },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Roadmap', slug: 'community/roadmap', badge: { text: 'UPD', variant: 'caution' } },
