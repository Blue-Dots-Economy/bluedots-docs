...
The cost compounds at national scale. MSMEs contribute roughly **70% of employment** in India but only about **30% of GDP** — constrained not by capital, but by the inability to find nearby talent, customers and services. Local discovery failure is a drag on the productivity of the firms that employ most Indians.

## The size of the opportunity

Enabling local discovery in India's **top 100 districts** alone represents a conservatively estimated **₹87,500 crore per year** opportunity — and that figure considers only livelihood enhancement. The full potential of local discovery across all sectors is significantly larger. See [The Economics of Local Discovery](/explore/economics/) for the full breakdown.
...
<BeforeAfter rows={[
  { dimension: "Jobs visible on platforms", before: "< 100 listings across the district", after: "10,000+ from just < 10% of MSMEs" },
  { dimension: "Cost to surface local intelligence", before: "₹500 / survey interaction", after: "₹10 / interaction (voice AI)" },
  { dimension: "Discovery time", before: "> 2 weeks", after: "< 2 days" },
  { dimension: "Distance of match", before: "Another city", after: "< 2 bus stops" },
  { dimension: "Placement / conversion rate", before: "~5%", after: "~50%" }
]} />

The remaining chapters explain *how* this is achieved — through the Blue Dots approach and the open DPGs that implement it. Continue to [The Blue Dots Approach](/overview/the-blue-dots-approach/).
