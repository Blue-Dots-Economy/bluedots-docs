...
description: The audiences this documentation serves and where each should start.
sidebar:
  order: 5
---

This documentation serves everyone building on or operating Blue Dots. Find your role below and jump to the right starting point.

## Adaptors & implementers
...
- Read [The Blue Dot Lifecycle](/core-concepts/blue-dot-lifecycle/) for the seven steps a participant walks, and who owns each one. <span class="bd-new" title="Added/updated from the adopter-guide PDF">new</span>
- Then follow [Adaptor Onboarding](/guides/adaptor-onboarding/) and the [Installation](/guides/installation/prerequisites/) guides.
- Tailor the deployment with [Customisation & Branding](/guides/customisation/). <span class="bd-new" title="Added/updated from the adopter-guide PDF">new</span>
...
- See [Core Concepts → Aggregators](/core-concepts/aggregators/) — including who qualifies and the four intake methods. <span class="bd-new" title="Added/updated from the adopter-guide PDF">new</span>
- Walk [The Blue Dot Lifecycle](/core-concepts/blue-dot-lifecycle/), especially the verification and *Blue Dot Verified* steps you own. <span class="bd-new" title="Added/updated from the adopter-guide PDF">new</span>
...
- Then [What We're Learning on the Ground](/explore/learnings/) for what live district operations are showing. <span class="bd-new" title="Added/updated from the adopter-guide PDF">new</span>
