...
sidebar:
  order: 4
prev:
  link: /core-concepts/technical/schema-driven-model/
  label: "Path 5 of 10: Schema-Driven Model"
next:
  link: /core-concepts/technical/read-write-paths/
  label: "Path 7 of 10: Read & Write Paths"
---
...
{/* Editable source: src/assets/diagrams/data-model-er.excalidraw — open at https://excalidraw.com to adjust, re-export PNG here. */}

![An item-type schema types many items (1—n); items interact via actions (1—n); each action produces events as structured results (1—n)](../../../../assets/diagrams/data-model-er.png)
...
- [Schema-Driven Model](/core-concepts/technical/schema-driven-model/) — how these tables are shaped by schemas rather than code.
- [Read & Write Paths](/core-concepts/technical/read-write-paths/) — how the data is actually queried and written.
