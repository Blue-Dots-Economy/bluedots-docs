...
![The Blue Dots layered architecture: Apps (Aggregator App, Signals App), Auth (Keycloak, Better-Auth), API (Aggregator API, Signals API), shared datastores (Redis, PostgreSQL, Object Storage) and integrations (SMTP, SMS)](../../../../assets/diagrams/high-level-architecture.png)
