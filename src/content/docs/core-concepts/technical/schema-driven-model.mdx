...
sidebar:
  order: 2
prev:
  link: /core-concepts/architecture/high-level-architecture/
  label: "Path 4 of 10: High-Level Architecture"
next:
...
- [Participant Profiles](/core-concepts/participant-profiles/) — the shipped schemas, field by field.
- [Data Model](/core-concepts/architecture/data-model/) — where schema-typed items are stored.
- [Configuration](/guides/configuration/) — which file each schema lives in.
