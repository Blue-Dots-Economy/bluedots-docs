...
sidebar:
  order: 1
prev:
  link: /overview/paradox-of-proximity/
  label: "Path 2 of 7: The Paradox of Proximity"
next:
  link: /explore/pilots/
...
:::note
The personas below — the jobseeking youth, the woman seeking nearby work, the citizen chasing a scheme, the person with a disability looking for support — each map to a colour-coded member of the "Dots family." For the full taxonomy, see [Beyond Livelihoods: The Dots Family](/explore/beyond-livelihoods/).
:::
...
**Pilot evidence:** 10,000+ jobs surfaced from under 10% of local MSMEs; discovery time cut from over two weeks to under two days; conversion around 50% in targeted drives, against around 5% conventional. See [Pilots](/explore/pilots/).
...
Field data sharpens what "suitable" means. Around **75% of women will not proceed without clarity on three things**: safety, closeness to home, and workplace amenities or shift timings. Women also search far closer to home than men — roughly two bus stops, against a district-wide search. Making those assurances visible *before* someone applies is as important as surfacing the role. See [What We're Learning](/explore/learnings/#7-women-are-asking-for-specific-assurances-before-taking-a-job).
...
![A seeker signal discovers a provider signal; an action between them produces an event — the outcome](../../../assets/diagrams/use-cases-common-pattern.png)

Adding a new use case means defining the **domain** and **item schemas** for it — not building a new system. See [Beyond Livelihoods](/explore/beyond-livelihoods/).
