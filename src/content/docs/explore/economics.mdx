...
:::caution[Caveats]
Districts with weaker SMB density or local linkages may generate less; stronger cluster districts more — **Ghaziabad is a reasonable mid-point**. The estimate also excludes compounding from repeat local-spending cycles.
:::
...
3. **SMB productivity & revenue** — faster hiring and customer discovery improves output.
